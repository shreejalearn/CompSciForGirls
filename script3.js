...
function typingEffect() {
    const contactTexts = shuffleArray([
        'Coding problem? Let’s solve it together! 😊',
        'Questions about programming? Ask me! 😄',
        'Innovative coding idea? Let’s chat! 💡',
        'Collaborate on a project? Let’s start! 🤗',
        'Need help with coding? I’m here! 👍'
      ]);
